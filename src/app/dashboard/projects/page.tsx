...
import { ProfileCard, ProjectCard } from "../page";
        ...
        <div className="w-1/4 border-gray-300 p-3 border rounded-lg flex flex-col space-y-4">
          ...
          <div className="">
            ...
            <div className="relative w-full">
              <select
                id="jobType"
                className="w-full mt-2 px-3 py-3 text-sm pr-10 border border-gray-300 rounded-md appearance-none focus:ring-blue-700 focus:border-blue-700"
              >
